...
<div class="panel login-panel">
    <form role="form" method="post" action="login">
        ...
        <div class="form-group login-text">
            <label>用户名:</label>
            <input type="text" class="form-control" name="loginName" placeholder="请输入您的用户名" required autofocus>
        </div>
        <div class="form-group login-text">
            <label>密码：</label>
        ...
        <div class="form-group login-text">
            <label>验证码：</label><input class="form-control login-inputcode"
                                      type="text" name="codetext"/>&nbsp;&nbsp;&nbsp;
            <img id="code" src="code" onclick="checkcode()" tyle="width:100px;height:30px;">
        </div>
